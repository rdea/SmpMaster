...
namespace SimplCommerce.Module.Orders.Services
{
    public interface IOrderService
    {
        ...
        Task<Result<Order>> CreateOrder(long cartId, string paymentMethod, decimal paymentFeeAmount, OrderStatus orderStatus = OrderStatus.New, string ip = "1", string token = "1");
